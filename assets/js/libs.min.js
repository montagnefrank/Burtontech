...
if (function (t, e) {
    ...
    function a() {
        (ht.addEventListener || "load" === event.type || "complete" === ht.readyState) && (s(), it.ready())
    }
    ...
    function c(t) {
        var e;
        for (e in t)
            if (("data" !== e || !it.isEmptyObject(t[e])) && "toJSON" !== e)
                return !1;
        return !0
    }
    ...
    function u(t, e, n, i) {
        if (it.acceptData(t)) {
            var o, r, s = it.expando,
                    a = t.nodeType,
                    l = a ? it.cache : t,
                    c = a ? t[s] : t[s] && s;
            if (c && l[c] && (i || l[c].data) || void 0 !== n || "string" != typeof e)
                return c || (c = a ? t[s] = X.pop() || it.guid++ : s), l[c] || (l[c] = a ? {} : {
                    toJSON: it.noop
                }), ("object" == typeof e || "function" == typeof e) && (i ? l[c] = it.extend(l[c], e) : l[c].data = it.extend(l[c].data, e)), r = l[c], i || (r.data || (r.data = {}), r = r.data), void 0 !== n && (r[it.camelCase(e)] = n), "string" == typeof e ? null == (o = r[e]) && (o = r[it.camelCase(e)]) : o = r, o
        }
    }
        ...
        if (it.acceptData(t)) {
            ...
            if (s[a]) {
                if (e && (i = n ? s[a] : s[a].data)) {
                    ...
                    for (; o--; )
                        delete i[e[o]];
                    if (n ? !c(i) : !it.isEmptyObject(i))
                        return
                }
                (n || (delete s[a].data, c(s[a]))) && (r ? it.cleanData([t], !0) : et.deleteExpando || s != s.window ? delete s[a] : s[a] = null)
            }
        }
    }
    ...
    function v(t, e) {
        var n, i, o = 0,
                r = typeof t.getElementsByTagName !== wt ? t.getElementsByTagName(e || "*") : typeof t.querySelectorAll !== wt ? t.querySelectorAll(e || "*") : void 0;
        if (!r)
            for (r = [], n = t.childNodes || t; null != (i = n[o]); o++)
                !e || it.nodeName(i, e) ? r.push(i) : it.merge(r, v(i, e));
    ...
    function w(t, e) {
        for (var n, i = 0; null != (n = t[i]); i++)
            it._data(n, "globalEval", !e || it._data(e[i], "globalEval"))
    }

    function k(t, e) {
        if (1 === e.nodeType && it.hasData(t)) {
            var n, i, o, r = it._data(t),
                    s = it._data(e, r),
                    a = r.events;
            if (a) {
    ...
    function T(t, e) {
        var n, i, o;
        if (1 === e.nodeType) {
            if (n = e.nodeName.toLowerCase(), !et.noCloneEvent && e[it.expando]) {
                o = it._data(e);
                for (i in o.events)
                    it.removeEvent(e, i, o.handle);
                e.removeAttribute(it.expando)
            }
            "script" === n && e.text !== t.text ? (b(e).text = t.text, x(e)) : "object" === n ? (e.parentNode && (e.outerHTML = t.outerHTML), et.html5Clone && t.innerHTML && !it.trim(e.innerHTML) && (e.innerHTML = t.innerHTML)) : "input" === n && Nt.test(t.type) ? (e.defaultChecked = e.checked = t.checked, e.value !== t.value && (e.value = t.value)) : "option" === n ? e.defaultSelected = e.selected = t.defaultSelected : ("input" === n || "textarea" === n) && (e.defaultValue = t.defaultValue)
        }
    }
    ...
    function S(t) {
        var e = ht,
                n = Yt[t];
        return n || ("none" !== (n = C(t, e)) && n || (Jt = (Jt || it("<iframe frameborder='0' width='0' height='0'/>")).appendTo(e.documentElement), (e = (Jt[0].contentWindow || Jt[0].contentDocument).document).write(), e.close(), n = C(t, e), Jt.detach()), Yt[t] = n), n
    }
    ...
    function N(t, e) {
        for (var n, i, o, r = [], s = 0, a = t.length; a > s; s++)
            (i = t[s]).style && (r[s] = it._data(i, "olddisplay"), n = i.style.display, e ? (r[s] || "none" !== n || (i.style.display = ""), "" === i.style.display && Et(i) && (r[s] = it._data(i, "olddisplay", S(i.nodeName)))) : (o = Et(i), (n && "none" !== n || !o) && it._data(i, "olddisplay", o ? n : it.css(i, "display"))));
        for (s = 0; a > s; s++)
    ...
    function $(t, e, n, i, o) {
        for (var r = n === (i ? "border" : "content") ? 4 : "width" === e ? 1 : 0, s = 0; 4 > r; r += 2)
            "margin" === n && (s += it.css(t, n + St[r], !0, o)), i ? ("content" === n && (s -= it.css(t, "padding" + St[r], !0, o)), "margin" !== n && (s -= it.css(t, "border" + St[r] + "Width", !0, o))) : (s += it.css(t, "padding" + St[r], !0, o), "padding" !== n && (s += it.css(t, "border" + St[r] + "Width", !0, o)));
        return s
    }
    ...
    function D(t, e, n) {
        var i = !0,
                ...
                r = Gt(t),
                s = et.boxSizing && "border-box" === it.css(t, "boxSizing", !1, r);
        if (0 >= o || null == o) {
            if ((0 > (o = Kt(t, e, r)) || null == o) && (o = t.style[e]), te.test(o))
                return o;
    ...
    function M(t, e) {
        ...
        for (e = e ? 1 : 0; 4 > o; o += 2 - e)
            n = St[o], i["margin" + n] = i["padding" + n] = t;
        return e && (i.opacity = i.width = t), i
    }

    function L(t, e, n) {
        for (var i, o = (ve[e] || []).concat(ve["*"]), r = 0, s = o.length; s > r; r++)
            if (i = o[r].call(n, e, t))
                return i
    }
        ...
        var i, o, r = 0,
            ...
            delete l.elem
                ...
                l = function () {
                    if (o)
                        return !1;
                    for (var e = ue || I(), n = Math.max(0, c.startTime + c.duration - e), i = 1 - (n / c.duration || 0), r = 0, s = c.tweens.length; s > r; r++)
                        c.tweens[r].run(i);
    ...
    function B(t, e, n, i) {
        ...
        if (it.isArray(e))
            it.each(e, function (e, o) {
                n || Be.test(t) ? i(t, o) : B(t + "[" + ("object" == typeof o ? e : "") + "]", o, n, i)
            });
        else if (n || "object" !== it.type(e))
            i(t, e);
        else
            for (o in e)
                B(t + "[" + o + "]", e[o], n, i)
    ...
    it.fn = it.prototype = {
        ...
        for ("boolean" == typeof s && (c = s, s = arguments[a] || {}, a++), "object" == typeof s || it.isFunction(s) || (s = {}), a === l && (s = this, a--); l > a; a++)
            if (null != (o = arguments[a]))
                for (i in o)
                    t = s[i], n = o[i], s !== n && (c && n && (it.isPlainObject(n) || (e = it.isArray(n))) ? (e ? (e = !1, r = t && it.isArray(t) ? t : []) : r = t && it.isPlainObject(t) ? t : {}, s[i] = it.extend(c, r, n)) : void 0 !== n && (s[i] = n));
        return s
    }, it.extend({
        ...
        isPlainObject: function (t) {
            var e;
            if (!t || "object" !== it.type(t) || t.nodeType || it.isWindow(t))
                return !1;
            try {
                if (t.constructor && !tt.call(t, "constructor") && !tt.call(t.constructor.prototype, "isPrototypeOf"))
                    return !1
            } catch (t) {
                return !1
            }
        ...
        type: function (t) {
            return null == t ? t + "" : "object" == typeof t || "function" == typeof t ? K[Z.call(t)] || "object" : typeof t
        },
        ...
        makeArray: function (t, e) {
            var i = e || [];
            return null != t && (n(Object(t)) ? it.merge(i, "string" == typeof t ? [t] : t) : Y.call(i, t)), i
        },
        ...
        proxy: function (t, e) {
            var n, i, o;
            return "string" == typeof e && (o = t[e], e = t, t = o), it.isFunction(t) ? (n = Q.call(arguments, 2), i = function () {
                return t.apply(e || this, n.concat(Q.call(arguments)))
            }, i.guid = t.guid = t.guid || it.guid++, i) : void 0
        },
        now: function () {
            return +new Date
        },
    ...
    var lt = function (t) {
        function e(t, e, n, i) {
            var o, r, s, a, c, d, p, h, f, m;
            if ((e ? e.ownerDocument || e : F) !== $ && A(e), e = e || $, n = n || [], !t || "string" != typeof t)
                return n;
            ...
            if (j && !i) {
                if (o = vt.exec(t))
                    if (s = o[1]) {
                        if (9 === a) {
                            ...
                            if (r.id === s)
                                return n.push(r), n
                        } else if (e.ownerDocument && (r = e.ownerDocument.getElementById(s)) && O(e, r) && r.id === s)
                            return n.push(r), n
                    } else {
                        if (o[2])
                ...
                if (b.qsa && (!I || !I.test(t))) {
                    if (h = p = P, f = e, m = 9 === a && t, 1 === a && "object" !== e.nodeName.toLowerCase()) {
                        for (d = T(t), (p = e.getAttribute("id")) ? h = p.replace(yt, "\\$&") : e.setAttribute("id", h), h = "[id='" + h + "'] ", c = d.length; c--; )
                            d[c] = h + u(d[c]);
                        f = gt.test(t) && l(e.parentNode) || e, m = d.join(",")
                    }
                    if (m)
                        try {
        ...
        function d(t, e, n) {
            ...
            return e.first ? function (e, n, r) {
                ...
                if (s) {
                    ...
                    for (; e = e[i]; )
                        if (1 === e.nodeType || o) {
                            if (l = e[P] || (e[P] = {}), (a = l[i]) && a[0] === H && a[1] === r)
                                return c[2] = a[2];
        ...
        function m(t, e, n, o, r, s) {
            return o && !o[P] && (o = m(o)), r && !r[P] && (r = m(r, s)), i(function (i, s, a, l) {
                var c, u, d, p = [],
                        ...
                        y = !t || !i && e ? g : f(g, p, t, a, l),
                        b = n ? r || (i ? t : v || o) ? [] : s : y;
                if (n && n(y, b, a, l), o)
                    for (c = f(b, m), o(c, [], a, l), u = c.length; u--; )
                        (d = c[u]) && (b[m[u]] = !(y[m[u]] = d));
                if (i) {
                    if (r || t) {
                        if (r) {
                        ...
                        for (u = b.length; u--; )
                            (d = b[u]) && (c = r ? Z.call(i, d) : p[u]) > -1 && (i[c] = !(s[c] = d))
                    }
                } else
                    b = f(b === s ? b.splice(v, b.length) : b), r ? r(null, s, b, l) : G.apply(s, b)
            })
        }
                ...
                if (n = x.relative[t[a].type])
                    ...
                    if ((n = x.filter[t[a].type].apply(null, t[a].matches))[P]) {
                        ...
                        return m(a > 1 && p(h), a > 1 && u(t.slice(0, a - 1).concat({
                            value: " " === t[a - 2].type ? "*" : ""
                        })).replace(st, "$1"), n, i > a && v(t.slice(a, i)), o > i && v(t = t.slice(i)), o > i && u(t))
                    }
                    h.push(n)
                }
            return p(h)
                    ...
                    s = function (i, s, a, l, c) {
                        ...
                        if (h += m, o && m !== h) {
                            ...
                            if (i) {
                                if (h > 0)
                                    for (; m--; )
                                        v[m] || g[m] || (g[m] = J.call(l));
                                g = f(g)
                            }
                            G.apply(l, g), c && !i && g.length > 0 && h + n.length > 1 && e.uniqueSort(l)
                        }
                        return c && (H = w, E = y), v
                    };
            return o ? i(s) : s
        }
        var y, b, x, w, k, T, C, S, E, _, N, A, $, D, j, I, M, L, O, P = "sizzle" + -new Date,
                F = t.document,
                H = 0,
                q = 0,
                R = n(),
        ...
        try {
            G.apply(Q = K.call(F.childNodes), F.childNodes), Q[F.childNodes.length].nodeType
        } catch (t) {
            G = {
        ...
        b = e.support = {}, k = e.isXML = function (t) {
            ...
            var e, n = t ? t.ownerDocument || t : F,
                    i = n.defaultView;
            return n !== $ && 9 === n.nodeType && n.documentElement ? ($ = n, D = n.documentElement, j = !k(n), i && i !== i.top && (i.addEventListener ? i.addEventListener("unload", function () {
                A()
            ...
            }, M = [], I = [], (b.qsa = mt.test(n.querySelectorAll)) && (o(function (t) {
            ...
            })), (b.matchesSelector = mt.test(L = D.matches || D.webkitMatchesSelector || D.mozMatchesSelector || D.oMatchesSelector || D.msMatchesSelector)) && o(function (t) {
                b.disconnectedMatch = L.call(t, "div"), L.call(t, "[s!='']:x"), M.push("!=", rt)
            }), I = I.length && new RegExp(I.join("|")), M = M.length && new RegExp(M.join("|")), e = mt.test(D.compareDocumentPosition), O = e || mt.test(D.contains) ? function (t, e) {
                ...
                return i || (i = (t.ownerDocument || t) === (e.ownerDocument || e) ? t.compareDocumentPosition(e) : 1, 1 & i || !b.sortDetached && e.compareDocumentPosition(t) === i ? t === n || t.ownerDocument === F && O(F, t) ? -1 : e === n || e.ownerDocument === F && O(F, e) ? 1 : _ ? Z.call(_, t) - Z.call(_, e) : 0 : 4 & i ? -1 : 1)
            } : function (t, e) {
                if (t === e)
                    return N = !0, 0;
                var i, o = 0,
                        ...
                        c = [e];
                if (!r || !a)
                    return t === n ? -1 : e === n ? 1 : r ? -1 : a ? 1 : _ ? Z.call(_, t) - Z.call(_, e) : 0;
                if (r === a)
                    return s(t, e);
            ...
            if ((t.ownerDocument || t) !== $ && A(t), n = n.replace(ct, "='$1']"), !(!b.matchesSelector || !j || M && M.test(n) || I && I.test(n)))
                try {
                    var i = L.call(t, n);
            ...
            var e, n = [],
                    i = 0,
                    o = 0;
            if (N = !b.detectDuplicates, _ = !b.sortStable && t.slice(0), t.sort(W), N) {
                for (; e = t[o++]; )
                    e === t[o] && (i = n.push(o));
                for (; i--; )
                    t.splice(n[i], 1)
                    ...
                    return 1 === i && 0 === o ? function (t) {
                        ...
                        if (v) {
                            ...
                            if (f = [s ? v.firstChild : v.lastChild], s && y) {
                                for (h = (c = (u = v[P] || (v[P] = {}))[t] || [])[0] === H && c[1], p = c[0] === H && c[2], d = h && v.childNodes[h]; d = ++h && d && d[m] || (p = h = 0) || f.pop(); )
                                    if (1 === d.nodeType && ++p && d === e) {
                                        u[t] = [H, h, p];
                                        break
                                    }
                            } else if (y && (c = (e[P] || (e[P] = {}))[t]) && c[0] === H)
                                p = c[1];
                            else
                                for (;
                                        (d = ++h && d && d[m] || (p = h = 0) || f.pop()) && ((a ? d.nodeName.toLowerCase() !== g : 1 !== d.nodeType) || !++p || (y && ((d[P] || (d[P] = {}))[t] = [H, p]), d !== e)); )
                                    ;
        ...
        return c.prototype = x.filters = x.pseudos, x.setFilters = new c, T = e.tokenize = function (t, n) {
            ...
            for (a = t, l = [], c = x.preFilter; a; ) {
                ...
                for (s in x.filter)
                    !(o = pt[s].exec(a)) || c[s] && !(o = c[s](o)) || (i = o.shift(), r.push({
                        value: i,
                        type: s,
                        matches: o
                    }), a = a.slice(i.length));
            ...
            if (!r) {
                ...
                (r = B(t, g(o, i))).selector = t
            }
            return r
        }, S = e.select = function (t, e, n, i) {
            var o, r, s, a, c, d = "function" == typeof t && t,
                    p = !i && T(t = d.selector || t);
            if (n = n || [], 1 === p.length) {
                if ((r = p[0] = p[0].slice(0)).length > 2 && "ID" === (s = r[0]).type && b.getById && 9 === e.nodeType && j && x.relative[r[1].type]) {
                ...
                for (o = pt.needsContext.test(t) ? 0 : r.length; o-- && (s = r[o], !x.relative[a = s.type]); )
                    if ((c = x.find[a]) && (i = c(s.matches[0].replace(bt, xt), gt.test(r[0].type) && l(e.parentNode) || e))) {
                        if (r.splice(o, 1), !(t = i.length && u(r)))
                            return G.apply(n, i), n;
                        break
                    }
            }
            return (d || C(t, p))(i, e, !j, n, gt.test(t) && l(e.parentNode) || e), n
        }, b.sortStable = P.split("").sort(W).join("") === P, b.detectDuplicates = !!N, A(), b.sortDetached = o(function (t) {
    ...
    it.filter = function (t, e, n) {
        ...
        find: function (t) {
            var e, n = [],
                    ...
                    o = i.length;
            if ("string" != typeof t)
                return this.pushStack(it(t).filter(function () {
                    for (e = 0; o > e; e++)
                        if (it.contains(i[e], this))
                            return !0
                }));
            for (e = 0; o > e; e++)
                it.find(t, i[e], n);
    ...
    (it.fn.init = function (t, e) {
        ...
        if (!t)
            return this;
        if ("string" == typeof t) {
            if (!(n = "<" === t.charAt(0) && ">" === t.charAt(t.length - 1) && t.length >= 3 ? [null, t, null] : ft.exec(t)) || !n[1] && e)
                return !e || e.jquery ? (e || pt).find(t) : this.constructor(e).find(t);
            if (n[1]) {
                if (e = e instanceof it ? e[0] : e, it.merge(this, it.parseHTML(n[1], e && e.nodeType ? e.ownerDocument || e : ht, !0)), ut.test(n[1]) && it.isPlainObject(e))
                    for (n in e)
                        it.isFunction(this[n]) ? this[n](e[n]) : this.attr(n, e[n]);
                return this
            }
        ...
        return t.nodeType ? (this.context = this[0] = t, this.length = 1, this) : it.isFunction(t) ? void 0 !== pt.ready ? pt.ready(t) : t(it) : (void 0 !== t.selector && (this.selector = t.selector, this.context = t.context), it.makeArray(t, this))
    }).prototype = it.fn, pt = it(ht);
    ...
    it.extend({
        dir: function (t, e, n) {
            for (var i = [], o = t[e]; o && 9 !== o.nodeType && (void 0 === n || 1 !== o.nodeType || !it(o).is(n)); )
        ...
        it.fn[t] = function (n, i) {
            ...
            return "Until" !== t.slice(-5) && (i = n), i && "string" == typeof i && (o = it.filter(i, o)), this.length > 1 && (vt[t] || (o = it.unique(o)), mt.test(t) && (o = o.reverse())), this.pushStack(o)
        }
    });
    var gt = /\S+/g,
            yt = {};
    it.Callbacks = function (t) {
        var e, n, i, o, s, a, l = [],
                c = !(t = "string" == typeof t ? yt[t] || r(t) : it.extend({}, t)).once && [],
                u = function (r) {
        ...
        when: function (t) {
            ...
            if (s > 1)
                for (e = new Array(s), n = new Array(s), i = new Array(s); s > o; o++)
                    r[o] && it.isFunction(r[o].promise) ? r[o].promise().done(c(o, i, r)).fail(l.reject).progress(c(o, n, e)) : --a;
    ...
    it.fn.ready = function (t) {
        ...
        ready: function (t) {
            if (!0 === t ? !--it.readyWait : !it.isReady) {
                ...
                it.isReady = !0, !0 !== t && --it.readyWait > 0 || (bt.resolveWith(ht, [it]), it.fn.triggerHandler && (it(ht).triggerHandler("ready"), it(ht).off("ready")))
            }
        }
    }), it.ready.promise = function (e) {
        if (!bt)
            if (bt = it.Deferred(), "complete" === ht.readyState)
                setTimeout(it.ready);
            else if (ht.addEventListener)
                ht.addEventListener("DOMContentLoaded", a, !1), t.addEventListener("load", a, !1);
            else {
    ...
    for (xt in it(et))
        break;
    et.ownLast = "0" !== xt, et.inlineBlockNeedsLayout = !1, it(function () {
        var t, e, n, i;
    ...
    it.extend({
        ...
        data: function (t, e) {
            var n, i, o, r = this[0],
                    s = r && r.attributes;
            if (void 0 === t) {
                if (this.length && (o = it.data(r), 1 === r.nodeType && !it._data(r, "parsedAttrs"))) {
                    for (n = s.length; n--; )
                        s[n] && 0 === (i = s[n].name).indexOf("data-") && (i = it.camelCase(i.slice(5)), l(r, i, o[i]));
        ...
        queue: function (t, e, n) {
            var i;
            return t ? (e = (e || "fx") + "queue", i = it._data(t, e), n && (!i || it.isArray(n) ? i = it._data(t, e, it.makeArray(n)) : i.push(n)), i || []) : void 0
        },
        ...
        promise: function (t, e) {
            ...
            for ("string" != typeof t && (e = t, t = void 0), t = t || "fx"; s--; )
                (n = it._data(r[s], t + "queueHooks")) && n.empty && (i++, n.empty.add(a));
    ...
    var Ct = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,
            ...
            _t = it.access = function (t, e, n, i, o, r, s) {
                var a = 0,
                        l = t.length,
                        c = null == n;
                if ("object" === it.type(n)) {
    ...
    !function () {
        ...
        if (e.innerHTML = "  <link/><table></table><a href='/a'>a</a><input type='checkbox'/>", et.leadingWhitespace = 3 === e.firstChild.nodeType, et.tbody = !e.getElementsByTagName("tbody").length, et.htmlSerialize = !!e.getElementsByTagName("link").length, et.html5Clone = "<:nav></:nav>" !== ht.createElement("nav").cloneNode(!0).outerHTML, t.type = "checkbox", t.checked = !0, n.appendChild(t), et.appendChecked = t.checked, e.innerHTML = "<textarea>x</textarea>", et.noCloneChecked = !!e.cloneNode(!0).lastChild.defaultValue, n.appendChild(e), e.innerHTML = "<input type='radio' checked='checked' name='t'/>", et.checkClone = e.cloneNode(!0).cloneNode(!0).lastChild.checked, et.noCloneEvent = !0, e.attachEvent && (e.attachEvent("onclick", function () {
            et.noCloneEvent = !1
            ...
            function () {
                ...
                submit: !0,
                    ...
                    n = "on" + e, (et[e + "Bubbles"] = n in t) || (i.setAttribute(n, "t"), et[e + "Bubbles"] = !1 === i.attributes[n].expando);
                i = null
            }();
    ...
    it.event = {
        ...
        add: function (t, e, n, i, o) {
            var r, s, a, l, c, u, d, p, h, f, m, v = it._data(t);
            if (v) {
                for (n.handler && (l = n, n = l.handler, o = l.selector), n.guid || (n.guid = it.guid++), (s = v.events) || (s = v.events = {}), (u = v.handle) || (u = v.handle = function(t) {
                return typeof it === wt || t && it.event.triggered === t.type ? void 0 : it.event.dispatch.apply(u.elem, arguments)
                }, u.elem = t), a = (e = (e || "").match(gt) || [""]).length; a--; )
                    r = It.exec(e[a]) || [], h = m = r[1], f = (r[2] || "").split(".").sort(), h && (c = it.event.special[h] || {}, h = (o ? c.delegateType : c.bindType) || h, c = it.event.special[h] || {}, d = it.extend({
                        type: h,
                        origType: m,
                        data: i,
                        handler: n,
                        ...
                        namespace: f.join(".")
                    }, l), (p = s[h]) || (p = s[h] = [], p.delegateCount = 0, c.setup && !1 !== c.setup.call(t, i, f, u) || (t.addEventListener ? t.addEventListener(h, u, !1) : t.attachEvent && t.attachEvent("on" + h, u))), c.add && (c.add.call(t, d), d.handler.guid || (d.handler.guid = n.guid)), o ? p.splice(p.delegateCount++, 0, d) : p.push(d), it.event.global[h] = !0);
                t = null
            }
        },
        remove: function (t, e, n, i, o) {
            var r, s, a, l, c, u, d, p, h, f, m, v = it.hasData(t) && it._data(t);
            if (v && (u = v.events)) {
                for (c = (e = (e || "").match(gt) || [""]).length; c--; )
                    if (a = It.exec(e[c]) || [], h = m = a[1], f = (a[2] || "").split(".").sort(), h) {
                        for (d = it.event.special[h] || {}, p = u[h = (i ? d.delegateType : d.bindType) || h] || [], a = a[2] && new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)"), l = r = p.length; r--; )
                            s = p[r], !o && m !== s.origType || n && n.guid !== s.guid || a && !a.test(s.namespace) || i && i !== s.selector && ("**" !== i || !s.selector) || (p.splice(r, 1), s.selector && p.delegateCount--, d.remove && d.remove.call(t, s));
                        l && !p.length && (d.teardown && !1 !== d.teardown.call(t, f, v.handle) || it.removeEvent(t, h, v.handle), delete u[h])
                    } else
                        for (h in u)
                            it.event.remove(t, h + e[c], n, i, !0);
                it.isEmptyObject(u) && (delete v.handle, it._removeData(t, "events"))
            }
        },
        trigger: function (e, n, i, o) {
            var r, s, a, l, c, u, d, p = [i || ht],
                    h = tt.call(e, "type") ? e.type : e,
                    f = tt.call(e, "namespace") ? e.namespace.split(".") : [];
            if (a = u = i = i || ht, 3 !== i.nodeType && 8 !== i.nodeType && !jt.test(h + it.event.triggered) && (h.indexOf(".") >= 0 && (f = h.split("."), h = f.shift(), f.sort()), s = h.indexOf(":") < 0 && "on" + h, e = e[it.expando] ? e : new it.Event(h, "object" == typeof e && e), e.isTrigger = o ? 2 : 3, e.namespace = f.join("."), e.namespace_re = e.namespace ? new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = i), n = null == n ? [e] : it.makeArray(n, [e]), c = it.event.special[h] || {}, o || !c.trigger || !1 !== c.trigger.apply(i, n))) {
                if (!o && !c.noBubble && !it.isWindow(i)) {
                    for (l = c.delegateType || h, jt.test(l + h) || (a = a.parentNode); a; a = a.parentNode)
                        p.push(a), u = a;
                    u === (i.ownerDocument || ht) && p.push(u.defaultView || u.parentWindow || t)
                }
                for (d = 0;
                        (a = p[d++]) && !e.isPropagationStopped(); )
                    e.type = d > 1 ? l : c.bindType || h, (r = (it._data(a, "events") || {})[e.type] && it._data(a, "handle")) && r.apply(a, n), (r = s && a[s]) && r.apply && it.acceptData(a) && (e.result = r.apply(a, n), !1 === e.result && e.preventDefault());
                if (e.type = h, !o && !e.isDefaultPrevented() && (!c._default || !1 === c._default.apply(p.pop(), n)) && it.acceptData(i) && s && i[h] && !it.isWindow(i)) {
                    (u = i[s]) && (i[s] = null), it.event.triggered = h;
                    try {
                        i[h]()
                    } catch (t) {
                    }
                    it.event.triggered = void 0, u && (i[s] = u)
                }
                return e.result
            }
        },
            ...
            if (a[0] = t, t.delegateTarget = this, !c.preDispatch || !1 !== c.preDispatch.call(this, t)) {
                for (s = it.event.handlers.call(this, t, l), e = 0;
                    ...
                    for (t.currentTarget = o.elem, r = 0;
                        ...
                        (!t.namespace_re || t.namespace_re.test(i.namespace)) && (t.handleObj = i, t.data = i.data, void 0 !== (n = ((it.event.special[i.origType] || {}).handle || i.handler).apply(o.elem, a)) && !1 === (t.result = n) && (t.preventDefault(), t.stopPropagation()));
            ...
            if (a && l.nodeType && (!t.button || "click" !== t.type))
                for (; l != this; l = l.parentNode || this)
                    if (1 === l.nodeType && (!0 !== l.disabled || "click" !== t.type)) {
                        for (o = [], r = 0; a > r; r++)
                            i = e[r], n = i.selector + " ", void 0 === o[n] && (o[n] = i.needsContext ? it(n, this).index(l) >= 0 : it.find(n, this, null, [l]).length), o[n] && o.push(i);
                        o.length && s.push({
                            elem: l,
                            handlers: o
                        })
        ...
        fix: function (t) {
            ...
            var e, n, i, o = t.type,
                    r = t,
                    s = this.fixHooks[o];
            for (s || (this.fixHooks[o] = s = Dt.test(o) ? this.mouseHooks : $t.test(o) ? this.keyHooks : {}), i = s.props ? this.props.concat(s.props) : this.props, t = new it.Event(r), e = i.length; e--; )
                n = i[e], t[n] = r[n];
        ...
        var i = "on" + e;
        t.detachEvent && (typeof t[i] === wt && (t[i] = null), t.detachEvent(i, n))
    }, it.Event = function (t, e) {
        return this instanceof it.Event ? (t && t.type ? (this.originalEvent = t, this.type = t.type, this.isDefaultPrevented = t.defaultPrevented || void 0 === t.defaultPrevented && !1 === t.returnValue ? p : h) : this.type = t, e && it.extend(this, e), this.timeStamp = t && t.timeStamp || it.now(), void(this[it.expando] = !0)) : new it.Event(t, e)
    }, it.Event.prototype = {
        ...
        setup: function () {
            return At.test(this.nodeName) ? (("checkbox" === this.type || "radio" === this.type) && (it.event.add(this, "propertychange._change", function (t) {
        ...
        on: function (t, e, n, i, o) {
            ...
            if (null == n && null == i ? (i = e, n = e = void 0) : null == i && ("string" == typeof e ? (i = n, n = void 0) : (i = n, n = e, e = void 0)), !1 === i)
                i = h;
            else if (!i)
                return this;
        ...
        off: function (t, e, n) {
            ...
            if (t && t.preventDefault && t.handleObj)
                return i = t.handleObj, it(t.delegateTarget).off(i.namespace ? i.origType + "." + i.namespace : i.origType, i.selector, i.handler), this;
            if ("object" == typeof t) {
                for (o in t)
                    this.off(o, e, t[o]);
                return this
    ...
    var Mt = "abbr|article|aside|audio|bdi|canvas|data|datalist|details|figcaption|figure|footer|header|hgroup|mark|meter|nav|output|progress|section|summary|time|video",
            ...
            Qt = m(ht).appendChild(ht.createElement("div"));
    Xt.optgroup = Xt.option, Xt.tbody = Xt.tfoot = Xt.colgroup = Xt.caption = Xt.thead, Xt.th = Xt.td, it.extend({
        clone: function (t, e, n) {
            var i, o, r, s, a, l = it.contains(t.ownerDocument, t);
            if (et.html5Clone || it.isXMLDoc(t) || !Ot.test("<" + t.nodeName + ">") ? r = t.cloneNode(!0) : (Qt.innerHTML = t.outerHTML, Qt.removeChild(r = Qt.firstChild)), !(et.noCloneEvent && et.noCloneChecked || 1 !== t.nodeType && 11 !== t.nodeType || it.isXMLDoc(t)))
                for (i = v(r), a = v(t), s = 0; null != (o = a[s]); ++s)
                    i[s] && T(o, i[s]);
            if (e)
                if (n)
                    for (a = a || v(t), i = i || v(r), s = 0; null != (o = a[s]); s++)
                        k(o, i[s]);
                else
                    k(t, r);
            return (i = v(r, "script")).length > 0 && w(i, !l && v(t, "script")), i = a = o = null, r
        },
        buildFragment: function (t, e, n, i) {
            for (var o, r, s, a, l, c, u, d = t.length, p = m(e), h = [], f = 0; d > f; f++)
                if ((r = t[f]) || 0 === r)
                    if ("object" === it.type(r))
                        it.merge(h, r.nodeType ? [r] : r);
                    else if (Rt.test(r)) {
                        for (a = a || p.appendChild(e.createElement("div")), l = (Ht.exec(r) || ["", ""])[1].toLowerCase(), u = Xt[l] || Xt._default, a.innerHTML = u[1] + r.replace(Ft, "<$1></$2>") + u[2], o = u[0]; o--; )
                            a = a.lastChild;
                        if (!et.leadingWhitespace && Pt.test(r) && h.push(e.createTextNode(Pt.exec(r)[0])), !et.tbody)
                            for (o = (r = "table" !== l || qt.test(r) ? "<table>" !== u[1] || qt.test(r) ? 0 : a : a.firstChild) && r.childNodes.length; o--; )
                                it.nodeName(c = r.childNodes[o], "tbody") && !c.childNodes.length && r.removeChild(c);
                        for (it.merge(h, a.childNodes), a.textContent = ""; a.firstChild; )
                            a.removeChild(a.firstChild);
                        a = p.lastChild
                    } else
                        h.push(e.createTextNode(r));
            for (a && p.removeChild(a), et.appendChecked || it.grep(v(h, "input"), g), f = 0; r = h[f++]; )
                if ((!i || -1 === it.inArray(r, i)) && (s = it.contains(r.ownerDocument, r), a = v(p.appendChild(r), "script"), s && w(a), n))
                    for (o = 0; r = a[o++]; )
                        Wt.test(r.type || "") && n.push(r);
            return a = null, p
        },
        cleanData: function (t, e) {
            for (var n, i, o, r, s = 0, a = it.expando, l = it.cache, c = et.deleteExpando, u = it.event.special; null != (n = t[s]); s++)
                if ((e || it.acceptData(n)) && (o = n[a], r = o && l[o])) {
                    if (r.events)
                        for (i in r.events)
                            u[i] ? it.event.remove(n, i) : it.removeEvent(n, i, r.handle);
                    l[o] && (delete l[o], c ? delete n[a] : typeof n.removeAttribute !== wt ? n.removeAttribute(a) : n[a] = null, X.push(o))
                }
        }
    }), it.fn.extend({
        text: function (t) {
            return _t(this, function (t) {
                return void 0 === t ? it.text(this) : this.empty().append((this[0] && this[0].ownerDocument || ht).createTextNode(t))
        ...
        remove: function (t, e) {
            for (var n, i = t ? it.filter(t, this) : this, o = 0; null != (n = i[o]); o++)
                e || 1 !== n.nodeType || it.cleanData(v(n)), n.parentNode && (e && it.contains(n.ownerDocument, n) && w(v(n, "script")), n.parentNode.removeChild(n));
            return this
        },
        empty: function () {
            for (var t, e = 0; null != (t = this[e]); e++) {
                for (1 === t.nodeType && it.cleanData(v(t, !1)); t.firstChild; )
        ...
        html: function (t) {
            return _t(this, function (t) {
                var e = this[0] || {},
                        ...
                        i = this.length;
                if (void 0 === t)
                    return 1 === e.nodeType ? e.innerHTML.replace(Lt, "") : void 0;
                if (!("string" != typeof t || zt.test(t) || !et.htmlSerialize && Ot.test(t) || !et.leadingWhitespace && Pt.test(t) || Xt[(Ht.exec(t) || ["", ""])[1].toLowerCase()])) {
                    t = t.replace(Ft, "<$1></$2>");
                    try {
                        for (; i > n; n++)
                            1 === (e = this[n] || {}).nodeType && (it.cleanData(v(e, !1)), e.innerHTML = t);
                        e = 0
                    } catch (t) {
                    }
                }
        ...
        replaceWith: function () {
            ...
            return this.domManip(arguments, function (e) {
                t = this.parentNode, it.cleanData(v(this)), t && t.replaceChild(e, this)
        ...
        domManip: function (t, e) {
            ...
            var n, i, o, r, s, a, l = 0,
                    ...
                    p = t[0],
                    h = it.isFunction(p);
            if (h || c > 1 && "string" == typeof p && !et.checkClone && Bt.test(p))
            ...
            if (c && (a = it.buildFragment(t, this[0].ownerDocument, !1, this), n = a.firstChild, 1 === a.childNodes.length && (a = n), n)) {
                for (o = (r = it.map(v(a, "script"), b)).length; c > l; l++)
                    i = a, l !== d && (i = it.clone(i, !0, !0), o && it.merge(r, v(i, "script"))), e.call(this[l], i, l);
                if (o)
                    for (s = r[r.length - 1].ownerDocument, it.map(r, x), l = 0; o > l; l++)
                        i = r[l], Wt.test(i.type || "") && !it._data(i, "globalEval") && it.contains(s, i) && (i.src ? it._evalUrl && it._evalUrl(i.src) : it.globalEval((i.text || i.textContent || i.innerHTML || "").replace(Vt, "")));
                a = n = null
            }
            return this
        }
        ...
        it.fn[t] = function (t) {
            for (var n, i = 0, o = [], r = it(t), s = r.length - 1; s >= i; i++)
                n = i === s ? this : this.clone(!0), it(r[i])[e](n), Y.apply(o, n.get());
    ...
    var Gt, Kt, Zt = /^margin/,
            te = new RegExp("^(" + Ct + ")(?!px)[a-z%]+$", "i"),
            ee = /^(top|right|bottom|left)$/;
    t.getComputedStyle ? (Gt = function (t) {
        return t.ownerDocument.defaultView.getComputedStyle(t, null)
    }, Kt = function (t, e, n) {
        var i, o, r, s, a = t.style;
        return n = n || Gt(t), s = n ? n.getPropertyValue(e) || n[e] : void 0, n && ("" !== s || it.contains(t.ownerDocument, t) || (s = it.style(t, e)), te.test(s) && Zt.test(e) && (i = a.width, o = a.minWidth, r = a.maxWidth, a.minWidth = a.maxWidth = a.width = s, s = n.width, a.width = i, a.minWidth = o, a.maxWidth = r)), void 0 === s ? s : s + ""
    }) : ht.documentElement.currentStyle && (Gt = function (t) {
        return t.currentStyle
    }, Kt = function (t, e, n) {
        var i, o, r, s, a = t.style;
        return n = n || Gt(t), null == (s = n ? n[e] : void 0) && a && a[e] && (s = a[e]), te.test(s) && !ee.test(e) && (i = a.left, o = t.runtimeStyle, (r = o && o.left) && (o.left = t.currentStyle.left), a.left = "fontSize" === e ? "1em" : s, s = a.pixelLeft + "px", a.left = i, r && (o.left = r)), void 0 === s ? s : s + "" || "auto"
    }),
            function () {
                function e() {
                    var e, n, i, o;
    ...
    it.extend({
        ...
        style: function (t, e, n, i) {
            if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
                var o, r, s, a = it.camelCase(e),
                        l = t.style;
                if (e = it.cssProps[a] || (it.cssProps[a] = _(l, a)), s = it.cssHooks[e] || it.cssHooks[a], void 0 === n)
                    return s && "get" in s && void 0 !== (o = s.get(t, !1, i)) ? o : l[e];
                if ("string" === (r = typeof n) && (o = se.exec(n)) && (n = (o[1] + 1) * o[2] + parseFloat(it.css(t, e)), r = "number"), null != n && n === n && ("number" !== r || it.cssNumber[a] || (n += "px"), et.clearCloneStyle || "" !== n || 0 !== e.indexOf("background") || (l[e] = "inherit"), !(s && "set" in s && void 0 === (n = s.set(t, n, i)))))
                    try {
                        l[e] = n
                    } catch (t) {
                    }
        ...
        css: function (t, e, n, i) {
            var o, r, s, a = it.camelCase(e);
            return e = it.cssProps[a] || (it.cssProps[a] = _(t.style, a)), (s = it.cssHooks[e] || it.cssHooks[a]) && "get" in s && (r = s.get(t, !0, n)), void 0 === r && (r = Kt(t, e, i)), "normal" === r && e in le && (r = le[e]), "" === n || n ? (o = parseFloat(r), !0 === n || it.isNumeric(o) ? o || 0 : r) : r
        }
    }), it.each(["height", "width"], function (t, e) {
        it.cssHooks[e] = {
            get: function (t, n, i) {
                return n ? oe.test(it.css(t, "display")) && 0 === t.offsetWidth ? it.swap(t, ae, function () {
                    return D(t, e, i)
                }) : D(t, e, i) : void 0
            },
            set: function (t, n, i) {
                var o = i && Gt(t);
                return A(t, n, i ? $(t, e, i, et.boxSizing && "border-box" === it.css(t, "boxSizing", !1, o), o) : 0)
            }
        }
        ...
        set: function (t, e) {
            ...
            n.zoom = 1, (e >= 1 || "" === e) && "" === it.trim(r.replace(ne, "")) && n.removeAttribute && (n.removeAttribute("filter"), "" === e || i && !i.filter) || (n.filter = ne.test(r) ? r.replace(ne, o) : r + " " + o)
        }
    }), it.cssHooks.marginRight = E(et.reliableMarginRight, function (t, e) {
        return e ? it.swap(t, {
            display: "inline-block"
        }, Kt, [t, "marginRight"]) : void 0
    }), it.each({
        margin: "",
        padding: "",
        border: "Width"
        ...
        it.cssHooks[t + e] = {
            expand: function (n) {
                for (var i = 0, o = {}, r = "string" == typeof n ? n.split(" ") : [n]; 4 > i; i++)
                    o[t + St[i] + e] = r[i] || r[i - 2] || r[0];
                return o
            }
        }, Zt.test(t) || (it.cssHooks[t + e].set = A)
    }), it.fn.extend({
        css: function (t, e) {
            return _t(this, function (t, e, n) {
                var i, o, r = {},
                        s = 0;
                if (it.isArray(e)) {
                    for (i = Gt(t), o = e.length; o > s; s++)
                        r[e[s]] = it.css(t, e[s], !1, i);
                    return r
                }
        ...
        run: function (t) {
            ...
            return this.pos = e = this.options.duration ? it.easing[this.easing](t, this.options.duration * t, 0, 1, this.options.duration) : t, this.now = (this.end - this.start) * e + this.start, this.options.step && this.options.step.call(this.elem, this.now, this), n && n.set ? n.set(this) : j.propHooks._default.set(this), this
        }
    ...
    var ue, de, pe = /^(?:toggle|show|hide)$/,
            ...
            me = [function (t, e, n) {
                    var i, o, r, s, a, l, c, u = this,
                            ...
                            h = t.nodeType && Et(t),
                            f = it._data(t, "fxshow");
                    n.queue || (null == (a = it._queueHooks(t, "fx")).unqueued && (a.unqueued = 0, l = a.empty.fire, a.empty.fire = function () {
                        a.unqueued || l()
                    }), a.unqueued++, u.always(function () {
                        u.always(function () {
                            a.unqueued--, it.queue(t, "fx").length || a.empty.fire()
                        })
                    })), 1 === t.nodeType && ("height" in e || "width" in e) && (n.overflow = [p.overflow, p.overflowX, p.overflowY], c = it.css(t, "display"), "inline" === ("none" === c ? it._data(t, "olddisplay") || S(t.nodeName) : c) && "none" === it.css(t, "float") && (et.inlineBlockNeedsLayout && "inline" !== S(t.nodeName) ? p.zoom = 1 : p.display = "inline-block")), n.overflow && (p.overflow = "hidden", et.shrinkWrapBlocks() || u.always(function () {
                    ...
                    for (i in e)
                        if (o = e[i], pe.exec(o)) {
                            ...
                            d[i] = f && f[i] || it.style(t, i)
                        } else
                            c = void 0;
                    if (it.isEmptyObject(d))
                        "inline" === ("none" === c ? S(t.nodeName) : c) && (p.display = c);
                    else {
                        f ? "hidden" in f && (h = f.hidden) : f = it._data(t, "fxshow", {}), r && (f.hidden = !h), h ? it(t).show() : u.done(function () {
                            it(t).hide()
                        }), u.done(function () {
                            var e;
                        ...
                        for (i in d)
                            s = L(h ? f[i] : 0, i, u), i in f || (f[i] = s.start, h && (s.end = s.start, s.start = "width" === i || "height" === i ? 1 : 0))
                    }
                }],
            ve = {
                "*": [function (t, e) {
                        var n = this.createTween(t, e),
                                ...
                                s = (it.cssNumber[t] || "px" !== r && +i) && he.exec(it.css(n.elem, t)),
                                a = 1,
                                l = 20;
                        if (s && s[3] !== r) {
                            r = r || s[3], o = o || [], s = +i || 1;
    ...
    it.Animation = it.extend(P, {
        tweener: function (t, e) {
            ...
            for (var n, i = 0, o = t.length; o > i; i++)
                n = t[i], ve[n] = ve[n] || [], ve[n].unshift(e)
        },
        ...
        finish: function (t) {
            return !1 !== t && (t = t || "fx"), this.each(function () {
                var e, n = it._data(this),
                        ...
                        r = it.timers,
                        s = i ? i.length : 0;
                for (n.finish = !0, it.queue(this, t, []), o && o.stop && o.stop.call(this, !0), e = r.length; e--; )
        ...
        var t, e = it.timers,
                n = 0;
        for (ue = it.now(); n < e.length; n++)
            (t = e[n])() || e[n] !== t || e.splice(n--, 1);
        e.length || it.fx.stop(), ue = void 0
        ...
        return t = it.fx ? it.fx.speeds[t] || t : t, e = e || "fx", this.queue(e, function (e, n) {
            ...
            function () {
                var t, e, n, i, o;
                (e = ht.createElement("div")).setAttribute("className", "t"), e.innerHTML = "  <link/><table></table><a href='/a'>a</a><input type='checkbox'/>", i = e.getElementsByTagName("a")[0], o = (n = ht.createElement("select")).appendChild(ht.createElement("option")), t = e.getElementsByTagName("input")[0], i.style.cssText = "top:1px", et.getSetAttribute = "t" !== e.className, et.style = /top/.test(i.getAttribute("style")), et.hrefNormalized = "/a" === i.getAttribute("href"), et.checkOn = !!t.value, et.optSelected = o.selected, et.enctype = !!ht.createElement("form").enctype, n.disabled = !0, et.optDisabled = !o.disabled, (t = ht.createElement("input")).setAttribute("value", ""), et.input = "" === t.getAttribute("value"), t.value = "t", t.setAttribute("type", "radio"), et.radioValue = "t" === t.value
            }();
    var ge = /\r/g;
    it.fn.extend({
        val: function (t) {
            ...
            })) : o ? (e = it.valHooks[o.type] || it.valHooks[o.nodeName.toLowerCase()], e && "get" in e && void 0 !== (n = e.get(o, "value")) ? n : (n = o.value, "string" == typeof n ? n.replace(ge, "") : null == n ? "" : n)) : void 0
        }
    }), it.extend({
        valHooks: {
            option: {
            ...
            select: {
                get: function (t) {
                    for (var e, n, i = t.options, o = t.selectedIndex, r = "select-one" === t.type || 0 > o, s = r ? null : [], a = r ? o + 1 : i.length, l = 0 > o ? a : r ? o : 0; a > l; l++)
                        if (!(!(n = i[l]).selected && l !== o || (et.optDisabled ? n.disabled : null !== n.getAttribute("disabled")) || n.parentNode.disabled && it.nodeName(n.parentNode, "optgroup"))) {
                            if (e = it(n).val(), r)
                                return e;
                            s.push(e)
                        }
                ...
                set: function (t, e) {
                    for (var n, i, o = t.options, r = it.makeArray(e), s = o.length; s--; )
                        if (i = o[s], it.inArray(it.valHooks.option.get(i), r) >= 0)
                            try {
                                i.selected = n = !0
                            } catch (t) {
                                i.scrollHeight
    ...
    var ye, be, xe = it.expr.attrHandle,
            we = /^(?:checked|selected)$/i,
            ke = et.getSetAttribute,
            Te = et.input;
    it.fn.extend({
        attr: function (t, e) {
        ...
        attr: function (t, e, n) {
            var i, o, r = t.nodeType;
            if (t && 3 !== r && 8 !== r && 2 !== r)
                return typeof t.getAttribute === wt ? it.prop(t, e, n) : (1 === r && it.isXMLDoc(t) || (e = e.toLowerCase(), i = it.attrHooks[e] || (it.expr.match.bool.test(e) ? be : ye)), void 0 === n ? i && "get" in i && null !== (o = i.get(t, e)) ? o : (o = it.find.attr(t, e), null == o ? void 0 : o) : null !== n ? i && "set" in i && void 0 !== (o = i.set(t, n, e)) ? o : (t.setAttribute(e, n + ""), n) : void it.removeAttr(t, e))
        },
        removeAttr: function (t, e) {
            ...
            if (r && 1 === t.nodeType)
                for (; n = r[o++]; )
                    i = it.propFix[n] || n, it.expr.match.bool.test(n) ? Te && ke || !we.test(n) ? t[i] = !1 : t[it.camelCase("default-" + n)] = t[i] = !1 : it.attr(t, n, ""), t.removeAttribute(ke ? n : i)
        },
        attrHooks: {
            type: {
                set: function (t, e) {
        ...
        set: function (t, e, n) {
            return !1 === e ? it.removeAttr(t, n) : Te && ke || !we.test(n) ? t.setAttribute(!ke && it.propFix[n] || n, n) : t[it.camelCase("default-" + n)] = t[n] = !0, n
        }
    }, it.each(it.expr.match.bool.source.match(/\w+/g), function (t, e) {
        var n = xe[e] || it.find.attr;
        xe[e] = Te && ke || !we.test(e) ? function (t, e, i) {
            var o, r;
            return i || (r = xe[e], xe[e] = o, o = null != n(t, e, i) ? e.toLowerCase() : null, xe[e] = r), o
        } : function (t, e, n) {
            return n ? void 0 : t[it.camelCase("default-" + e)] ? e.toLowerCase() : null
        }
    }), Te && ke || (it.attrHooks.value = {
        set: function (t, e, n) {
            return it.nodeName(t, "input") ? void(t.defaultValue = e) : ye && ye.set(t, e, n)
        }
    }), ke || (ye = {
        set: function (t, e, n) {
    ...
    it.fn.extend({
        ...
        prop: function (t, e, n) {
            var i, o, r = t.nodeType;
            if (t && 3 !== r && 8 !== r && 2 !== r)
                return (1 !== r || !it.isXMLDoc(t)) && (e = it.propFix[e] || e, o = it.propHooks[e]), void 0 !== n ? o && "set" in o && void 0 !== (i = o.set(t, n, e)) ? i : t[e] = n : o && "get" in o && null !== (i = o.get(t, e)) ? i : t[e]
        },
        propHooks: {
            tabIndex: {
                get: function (t) {
    ...
    it.fn.extend({
        ...
        toggleClass: function (t, e) {
            ...
            return "boolean" == typeof e && "string" === n ? e ? this.addClass(t) : this.removeClass(t) : this.each(it.isFunction(t) ? function (n) {
                ...
                if ("string" === n)
                    for (var e, i = 0, o = it(this), r = t.match(gt) || []; e = r[i++]; )
                        o.hasClass(e) ? o.removeClass(e) : o.addClass(e);
                else
                    (n === wt || "boolean" === n) && (this.className && it._data(this, "__className__", this.className), this.className = this.className || !1 === t ? "" : it._data(this, "__className__") || "")
            })
        },
        hasClass: function (t) {
    ...
    it.parseJSON = function (e) {
        ...
        var n, i = null,
                o = it.trim(e + "");
        return o && !it.trim(o.replace(Ae, function (t, e, o, r) {
    ...
    $e = Fe.exec(De.toLowerCase()) || [], it.extend({
        active: 0,
        lastModified: {},
        etag: {},
        ajaxSettings: {
        ...
        ajax: function (t, e) {
            function n(t, e, n, i) {
                var o, u, g, y, x, k = e;
                2 !== b && (b = 2, a && clearTimeout(a), c = void 0, s = i || "", w.readyState = t > 0 ? 4 : 0, o = t >= 200 && 300 > t || 304 === t, n && (y = R(d, w, n)), y = z(d, y, w, o), o ? (d.ifModified && ((x = w.getResponseHeader("Last-Modified")) && (it.lastModified[r] = x), (x = w.getResponseHeader("etag")) && (it.etag[r] = x)), 204 === t || "HEAD" === d.type ? k = "nocontent" : 304 === t ? k = "notmodified" : (k = y.state, u = y.data, g = y.error, o = !g)) : (g = k, (t || !k) && (k = "error", 0 > t && (t = 0))), w.status = t, w.statusText = (e || k) + "", o ? f.resolveWith(p, [u, k, w]) : f.rejectWith(p, [w, k, g]), w.statusCode(v), v = void 0, l && h.trigger(o ? "ajaxSuccess" : "ajaxError", [w, d, o ? u : g]), m.fireWith(p, [w, k]), l && (h.trigger("ajaxComplete", [w, d]), --it.active || it.event.trigger("ajaxStop")))
            }
            ...
            if (f.promise(w).complete = m.add, w.success = w.done, w.error = w.fail, d.url = ((t || d.url || De) + "").replace(je, "").replace(Pe, $e[1] + "//"), d.type = e.method || e.type || d.method || d.type, d.dataTypes = it.trim(d.dataType || "*").toLowerCase().match(gt) || [""], null == d.crossDomain && (i = Fe.exec(d.url.toLowerCase()), d.crossDomain = !(!i || i[1] === $e[1] && i[2] === $e[2] && (i[3] || ("http:" === i[1] ? "80" : "443")) === ($e[3] || ("http:" === $e[1] ? "80" : "443")))), d.data && d.processData && "string" != typeof d.data && (d.data = it.param(d.data, d.traditional)), H(He, d, e, w), 2 === b)
                return w;
            (l = d.global) && 0 == it.active++ && it.event.trigger("ajaxStart"), d.type = d.type.toUpperCase(), d.hasContent = !Oe.test(d.type), r = d.url, d.hasContent || (d.data && (r = d.url += (Ne.test(r) ? "&" : "?") + d.data, delete d.data), !1 === d.cache && (d.url = Ie.test(r) ? r.replace(Ie, "$1_=" + _e++) : r + (Ne.test(r) ? "&" : "?") + "_=" + _e++)), d.ifModified && (it.lastModified[r] && w.setRequestHeader("If-Modified-Since", it.lastModified[r]), it.etag[r] && w.setRequestHeader("If-None-Match", it.etag[r])), (d.data && d.hasContent && !1 !== d.contentType || e.contentType) && w.setRequestHeader("Content-Type", d.contentType), w.setRequestHeader("Accept", d.dataTypes[0] && d.accepts[d.dataTypes[0]] ? d.accepts[d.dataTypes[0]] + ("*" !== d.dataTypes[0] ? ", " + Re + "; q=0.01" : "") : d.accepts["*"]);
            for (o in d.headers)
                w.setRequestHeader(o, d.headers[o]);
            if (d.beforeSend && (!1 === d.beforeSend.call(p, w, d) || 2 === b))
                return w.abort();
            x = "abort";
            for (o in {
            success: 1,
    ...
    it.param = function (t, e) {
        ...
        if (void 0 === e && (e = it.ajaxSettings && it.ajaxSettings.traditional), it.isArray(t) || t.jquery && !it.isPlainObject(t))
            it.each(t, function () {
        ...
        serializeArray: function () {
            return this.map(function () {
                ...
                var t = this.type;
                return this.name && !it(this).is(":disabled") && Ve.test(this.nodeName) && !Ue.test(t) && (this.checked || !Nt.test(t))
            }).map(function (t, e) {
                var n = it(this).val();
    ...
    var Xe = 0,
            Qe = {},
            Je = it.ajaxSettings.xhr();
    t.ActiveXObject && it(t).on("unload", function () {
        for (var t in Qe)
            Qe[t](void 0, !0)
    }), et.cors = !!Je && "withCredentials" in Je, (Je = et.ajax = !!Je) && it.ajaxTransport(function (t) {
                ...
                send: function (n, i) {
                    ...
                    r.send(t.hasContent && t.data || null), e = function (n, o) {
                        ...
                        if (e && (o || 4 === r.readyState))
                            if (delete Qe[s], e = void 0, r.onreadystatechange = it.noop, o)
        ...
        if (t.crossDomain) {
            ...
            return {
                send: function (i, o) {
                    (e = ht.createElement("script")).async = !0, t.scriptCharset && (e.charset = t.scriptCharset), e.src = t.url, e.onload = e.onreadystatechange = function (t, n) {
    ...
    it.ajaxSetup({
        ...
        jsonpCallback: function () {
            var t = Ye.pop() || it.expando + "_" + _e++;
            return this[t] = !0, t
        }
    }), it.ajaxPrefilter("json jsonp", function (e, n, i) {
        var o, r, s, a = !1 !== e.jsonp && (Ge.test(e.url) ? "url" : "string" == typeof e.data && !(e.contentType || "").indexOf("application/x-www-form-urlencoded") && Ge.test(e.data) && "data");
        return a || "jsonp" === e.dataTypes[0] ? (o = e.jsonpCallback = it.isFunction(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, a ? e[a] = e[a].replace(Ge, "$1" + o) : !1 !== e.jsonp && (e.url += (Ne.test(e.url) ? "&" : "?") + e.jsonp + "=" + o), e.converters["script json"] = function () {
            return s || it.error(o + " was not called"), s[0]
        }, e.dataTypes[0] = "json", r = t[o], t[o] = function () {
            s = arguments
        }, i.always(function () {
            t[o] = r, e[o] && (e.jsonpCallback = n.jsonpCallback, Ye.push(o)), s && it.isFunction(r) && r(s[0]), s = r = void 0
        }), "script") : void 0
    ...
    it.fn.load = function (t, e, n) {
        ...
        var i, o, r, s = this,
                a = t.indexOf(" ");
        return a >= 0 && (i = it.trim(t.slice(a, t.length)), t = t.slice(0, a)), it.isFunction(e) ? (n = e, e = void 0) : e && "object" == typeof e && (r = "POST"), s.length > 0 && it.ajax({
            url: t,
            type: r,
            dataType: "html",
            data: e
    ...
    it.offset = {
        setOffset: function (t, e, n) {
            var i, o, r, s, a, l, c = it.css(t, "position"),
                    u = it(t),
                    d = {};
        ...
        offset: function (t) {
            ...
            var e, n, i = {
                ...
                left: 0
                    ...
                    o = this[0],
                    r = o && o.ownerDocument;
            return r ? (e = r.documentElement, it.contains(e, o) ? (typeof o.getBoundingClientRect !== wt && (i = o.getBoundingClientRect()), n = V(r), {
        ...
        offsetParent: function () {
            return this.map(function () {
                for (var t = this.offsetParent || Ze; t && !it.nodeName(t, "html") && "static" === it.css(t, "position"); )
                    t = t.offsetParent;
                return t || Ze
            })
        }
        ...
        it.fn[t] = function (i) {
            return _t(this, function (t, i, o) {
                var r = V(t);
                return void 0 === o ? r ? e in r ? r[e] : r.document.documentElement[i] : t[i] : void(r ? r.scrollTo(n ? it(r).scrollLeft() : o, n ? o : it(r).scrollTop()) : t[i] = o)
            }, t, i, arguments.length, null)
        }
    }), it.each(["top", "left"], function (t, e) {
        it.cssHooks[e] = E(et.pixelPosition, function (t, n) {
            return n ? (n = Kt(t, e), te.test(n) ? it(t).position()[e] + "px" : n) : void 0
        })
    }), it.each({
        Height: "height",
        Width: "width"
    ...
    return it.noConflict = function (e) {
        return t.$ === it && (t.$ = en), e && t.jQuery === it && (t.jQuery = tn), it
        ...
        function (t) {
            ...
            e.VERSION = "3.3.7", e.TRANSITION_DURATION = 150, e.DEFAULTS = {
                ...
                if (this.$element.trigger(s), !s.isDefaultPrevented())
                    return r.removeClass("in"), t.support.transition && r.hasClass("fade") ? r.one("bsTransitionEnd", i).emulateTransitionEnd(e.TRANSITION_DURATION) : i(), this.hoverState = null, this
        ...
        function (t) {
            ...
            e.prototype = {
                ...
                typewrite: function (t, e) {
                    if (!0 !== this.stop) {
                        ...
                        i.timeout = setTimeout(function () {
                            ...
                            if ("^" === o.charAt(0)) {
                                var r = 1;
                                /^\^\d+/.test(o) && (r += (o = /\d+/.exec(o)[0]).length, n = parseInt(o)), t = t.substring(0, e) + t.substring(e + r)
                            }
                            ...
                            i.timeout = setTimeout(function () {
                                if (e === t.length) {
                                    if (i.options.onStringTyped(i.arrayPos), i.arrayPos === i.strings.length - 1 && (i.options.callback(), i.curLoop++, !1 === i.loop || i.curLoop === i.loopCount))
                                        return;
                                    i.timeout = setTimeout(function () {
                                        i.backspace(t, e)
                                    }, i.backDelay)
                ...
                backspace: function (t, e) {
                    if (!0 !== this.stop) {
                        ...
                        i.timeout = setTimeout(function () {
                            ...
                            var o = t.substr(0, e);
                            i.attr ? i.el.attr(i.attr, o) : i.isInput ? i.el.val(o) : "html" === i.contentType ? i.el.html(o) : i.el.text(o), e > i.stopNum ? (e--, i.backspace(t, e)) : e <= i.stopNum && (++i.arrayPos === i.strings.length ? (i.arrayPos = 0, i.shuffle && (i.sequence = i.shuffleArray(i.sequence)), i.init()) : i.typewrite(i.strings[i.sequence[i.arrayPos]], e))
                        }, n)
                    }
                },
                shuffleArray: function (t) {
                    ...
                    if (i)
                        for (; --i; )
                            e = t[n = Math.floor(Math.random() * (i + 1))], t[n] = t[i], t[i] = e;
                    return t
                },
                reset: function () {
                    var t = this;
                ...
                return this.each(function () {
                    var i = t(this),
                            o = i.data("typed"),
                            r = "object" == typeof n && n;
                    o && o.reset(), i.data("typed", o = new e(this, r)), "string" == typeof n && o[n]()
                })
            }, t.fn.typed.defaults = {
            ...
            e = function () {
                ...
                return o.prototype.defaults = {
                    ...
                    if (this.stopped = !1, this.boxes = function () {
                        var t, n, i, o;
                        for (o = [], t = 0, n = (i = this.element.querySelectorAll("." + this.config.boxClass)).length; n > t; t++)
                            e = i[t], o.push(e);
                        return o
                        ...
                        return function (e) {
                            ...
                            for (s = [], n = 0, i = e.length; i > n; n++)
                                r = e[n], s.push(function () {
                                    var t, e, n, i;
                                    for (i = [], t = 0, e = (n = r.addedNodes || []).length; e > t; t++)
                    ...
                    if (null == t && (t = this.element), 1 === t.nodeType) {
                        for (r = [], n = 0, i = (o = (t = t.parentNode || t).querySelectorAll("." + this.config.boxClass)).length; i > n; n++)
                    ...
                    var n, o, r, s, a, l;
                    for (s = (a = i(t)).getPropertyCSSValue(e), n = 0, o = (r = this.vendors).length; o > n; n++)
    ...
    e && Object.deepExtend(i, e), i.tmp.obj = {
        ...
        if (this.radius = (i.particles.size.random ? Math.random() : 1) * i.particles.size.value, i.particles.size.anim.enable && (this.size_status = !1, this.vs = i.particles.size.anim.speed / 100, i.particles.size.anim.sync || (this.vs = this.vs * Math.random())), this.x = n ? n.x : Math.random() * i.canvas.w, this.y = n ? n.y : Math.random() * i.canvas.h, this.x > i.canvas.w - 2 * this.radius ? this.x = this.x - this.radius : this.x < 2 * this.radius && (this.x = this.x + this.radius), this.y > i.canvas.h - 2 * this.radius ? this.y = this.y - this.radius : this.y < 2 * this.radius && (this.y = this.y + this.radius), i.particles.move.bounce && i.fn.vendors.checkOverlap(this, n), this.color = {}, "object" == typeof t.value)
            if (t.value instanceof Array) {
                var o = t.value[Math.floor(Math.random() * i.particles.color.value.length)];
        ...
        if (void 0 != t.opacity_bubble)
            ...
            var n = t.opacity;
        if (t.color.rgb)
            o = "rgba(" + t.color.rgb.r + "," + t.color.rgb.g + "," + t.color.rgb.b + "," + n + ")";
        else
            var o = "hsla(" + t.color.hsl.h + "," + t.color.hsl.s + "%," + t.color.hsl.l + "%," + n + ")";
        switch (i.canvas.ctx.fillStyle = o, i.canvas.ctx.beginPath(), t.shape) {
            ...
            case "image":
                if ("svg" == i.tmp.img_type)
                    ...
                    var r = i.tmp.img_obj;
                r && i.canvas.ctx.drawImage(r, t.x - e, t.y - e, 2 * e, 2 * e / t.img.ratio)
        }
        i.canvas.ctx.closePath(), i.particles.shape.stroke.width > 0 && (i.canvas.ctx.strokeStyle = i.particles.shape.stroke.color, i.canvas.ctx.lineWidth = i.particles.shape.stroke.width, i.canvas.ctx.stroke()), i.canvas.ctx.fill()
    }, i.fn.particlesCreate = function () {
        for (var t = 0; t < i.particles.number.value; t++)
        ...
        for (var t = 0; t < i.particles.array.length; t++) {
            ...
            switch (e.x - e.radius > i.canvas.w ? (e.x = o.x_left, e.y = Math.random() * i.canvas.h) : e.x + e.radius < 0 && (e.x = o.x_right, e.y = Math.random() * i.canvas.h), e.y - e.radius > i.canvas.h ? (e.y = o.y_top, e.x = Math.random() * i.canvas.w) : e.y + e.radius < 0 && (e.y = o.y_bottom, e.x = Math.random() * i.canvas.w), i.particles.move.out_mode) {
                case "bounce":
            ...
            if (isInArray("grab", i.interactivity.events.onhover.mode) && i.fn.modes.grabParticle(e), (isInArray("bubble", i.interactivity.events.onhover.mode) || isInArray("bubble", i.interactivity.events.onclick.mode)) && i.fn.modes.bubbleParticle(e), (isInArray("repulse", i.interactivity.events.onhover.mode) || isInArray("repulse", i.interactivity.events.onclick.mode)) && i.fn.modes.repulseParticle(e), i.particles.line_linked.enable || i.particles.move.attract.enable)
                for (var r = t + 1; r < i.particles.array.length; r++) {
        ...
        if (Math.sqrt(n * n + o * o) <= i.particles.line_linked.distance) {
            var r = n / (1e3 * i.particles.move.attract.rotateX),
                    s = o / (1e3 * i.particles.move.attract.rotateY);
        ...
        function n(e, n, o, r, s) {
            if (e != n)
                if (i.tmp.bubble_duration_end)
                    void 0 != o && (l = e + (e - (r - d * (r - e) / i.interactivity.modes.bubble.duration)), "size" == s && (t.radius_bubble = l), "opacity" == s && (t.opacity_bubble = l));
                    ...
                    if (void 0 != o)
                        ...
                        var a = r;
                    if (a != e) {
                        var l = r - d * (r - e) / i.interactivity.modes.bubble.duration;
                        "size" == s && (t.radius_bubble = l), "opacity" == s && (t.opacity_bubble = l)
                    }
                } else
                    "size" == s && (t.radius_bubble = void 0), "opacity" == s && (t.opacity_bubble = void 0)
        }
        if (i.interactivity.events.onhover.enable && isInArray("bubble", i.interactivity.events.onhover.mode)) {
            var o = t.x - i.interactivity.mouse.pos_x,
                    r = t.y - i.interactivity.mouse.pos_y,
                    s = 1 - (u = Math.sqrt(o * o + r * r)) / i.interactivity.modes.bubble.distance;
            if (u <= i.interactivity.modes.bubble.distance) {
                if (s >= 0 && "mousemove" == i.interactivity.status) {
                    if (i.interactivity.modes.bubble.size != i.particles.size.value)
                        if (i.interactivity.modes.bubble.size > i.particles.size.value)
                            (l = t.radius + i.interactivity.modes.bubble.size * s) >= 0 && (t.radius_bubble = l);
                        else {
                            var a = t.radius - i.interactivity.modes.bubble.size,
                                    l = t.radius - a * s;
                            t.radius_bubble = l > 0 ? l : 0
                        }
                    if (i.interactivity.modes.bubble.opacity != i.particles.opacity.value)
                        if (i.interactivity.modes.bubble.opacity > i.particles.opacity.value)
                            (c = i.interactivity.modes.bubble.opacity * s) > t.opacity && c <= i.interactivity.modes.bubble.opacity && (t.opacity_bubble = c);
                        else {
                            var c = t.opacity - (i.particles.opacity.value - i.interactivity.modes.bubble.opacity) * s;
                            c < t.opacity && c >= i.interactivity.modes.bubble.opacity && (t.opacity_bubble = c)
                        }
                }
            } else
                e();
            ...
            if (i.tmp.bubble_clicking) {
                var o = t.x - i.interactivity.mouse.click_pos_x,
                        r = t.y - i.interactivity.mouse.click_pos_y,
                        u = Math.sqrt(o * o + r * r),
        ...
        if (i.interactivity.events.onhover.enable && isInArray("repulse", i.interactivity.events.onhover.mode) && "mousemove" == i.interactivity.status) {
            ...
            "bounce" == i.particles.move.out_mode ? (a.x - t.radius > 0 && a.x + t.radius < i.canvas.w && (t.x = a.x), a.y - t.radius > 0 && a.y + t.radius < i.canvas.h && (t.y = a.y)) : (t.x = a.x, t.y = a.y)
            ...
            if (i.tmp.repulse_finish || ++i.tmp.repulse_count == i.particles.array.length && (i.tmp.repulse_finish = !0), i.tmp.repulse_clicking) {
                ...
                l >= d && function () {
                    ...
                    if (t.vx = p * Math.cos(e), t.vy = p * Math.sin(e), "bounce" == i.particles.move.out_mode) {
                        var n = {
                            x: t.x + t.vx,
                            y: t.y + t.vy
                        };
                ...
                0 == i.tmp.repulse_clicking && (t.vx = t.vx_i, t.vy = t.vy_i)
        ...
        if (i.interactivity.events.onhover.enable && "mousemove" == i.interactivity.status) {
            ...
            if (o <= i.interactivity.modes.grab.distance) {
                ...
                if (r > 0) {
                    ...
                    i.canvas.ctx.strokeStyle = "rgba(" + s.r + "," + s.g + "," + s.b + "," + r + ")", i.canvas.ctx.lineWidth = i.particles.line_linked.width, i.canvas.ctx.beginPath(), i.canvas.ctx.moveTo(t.x, t.y), i.canvas.ctx.lineTo(i.interactivity.mouse.pos_x, i.interactivity.mouse.pos_y), i.canvas.ctx.stroke(), i.canvas.ctx.closePath()
                }
            }
        }
        ...
        for (var n = 0; n < i.particles.array.length; n++) {
            var o = i.particles.array[n],
                    r = t.x - o.x,
                    s = t.y - o.y;
            Math.sqrt(r * r + s * s) <= t.radius + o.radius && (t.x = e ? e.x : Math.random() * i.canvas.w, t.y = e ? e.y : Math.random() * i.canvas.h, i.fn.vendors.checkOverlap(t))
        }
    }, i.fn.vendors.createSvgImg = function (t) {
        var e = /#([0-9A-F]{3,6})/gi,
                n = i.tmp.source_svg.replace(e, function (e, n, i, o) {
                    if (t.color.rgb)
                        r = "rgba(" + t.color.rgb.r + "," + t.color.rgb.g + "," + t.color.rgb.b + "," + t.opacity + ")";
                    else
                        var r = "hsla(" + t.color.hsl.h + "," + t.color.hsl.s + "%," + t.color.hsl.l + "%," + t.opacity + ")";
                    return r
                }),
                o = new Blob([n], {
        ...
        a.addEventListener("load", function () {
            t.img.obj = a, t.img.loaded = !0, r.revokeObjectURL(s), i.tmp.count_svg++
        }), a.src = s
    }, i.fn.vendors.destroypJS = function () {
        cancelAnimationFrame(i.fn.drawAnimFrame), n.remove(), pJSDom = null
    }, i.fn.vendors.drawShape = function (t, e, n, i, o, r) {
        var s = o * r,
                a = o / r,
                l = 180 * (a - 2) / a,
        ...
        for (var u = 0; s > u; u++)
            t.lineTo(i, 0), t.translate(i, 0), t.rotate(c);
        t.fill(), t.restore()
...
Object.deepExtend = function (t, e) {
    for (var n in e)
        e[n] && e[n].constructor && e[n].constructor === Object ? (t[n] = t[n] || {}, arguments.callee(t[n], e[n])) : t[n] = e[n];
    return t
    ...
    r.className = i, r.style.width = "100%", r.style.height = "100%", null != document.getElementById(t).appendChild(r) && pJSDom.push(new pJS(t, e))
    ...
    i.open("GET", e), i.onreadystatechange = function (e) {
        ...
        function () {
            ...
            !function (t, e) {
                ...
                var o, r, s, a, l, c, u, d, p, h, f, m, v, g, y, b;
                return o = n(i), d = t.call(i, "ontouchstart") >= 0, a = {
                    horizontal: {},
                    vertical: {}
                }, l = 1, u = {}, c = "waypoints-context-id", f = "resize.waypoints", m = "scroll.waypoints", v = 1, g = "waypoints-waypoint-ids", y = "waypoint", b = "waypoints", r = function () {
                    function t(t) {
                        var e = this;
                        ...
                        return i = n.isWindow(this.element), e = this.$element.offset(), this.doScroll(), t = {
                            ...
                            return n.each(o.waypoints[t], function (t, i) {
                                ...
                                if (o = i.options.offset, s = i.offset, r = n.isWindow(i.element) ? 0 : i.$element.offset()[e.offsetProp], n.isFunction(o) ? o = o.apply(i.element) : "string" == typeof o && (o = parseFloat(o), i.options.offset.indexOf("%") > -1 && (o = Math.ceil(e.contextDimension * o / 100))), i.offset = r - e.contextOffset + e.contextScroll - o, (!i.options.onlyOnScroll || null == s) && i.enabled)
                                    return null !== s && s < (a = e.oldScroll) && a <= i.offset ? i.trigger([e.backward]) : null !== s && s > (l = e.oldScroll) && l >= i.offset ? i.trigger([e.forward]) : null === s && e.oldScroll >= i.offset ? i.trigger([e.forward]) : void 0
                            })
                        })
                    }, t.prototype.checkEmpty = function () {
                        if (n.isEmptyObject(this.waypoints.horizontal) && n.isEmptyObject(this.waypoints.vertical))
                            return this.$element.unbind([f, m].join(" ")), delete u[this.id]
                    }, t
                }(), s = function () {
                    function t(t, e, i) {
                        var o, r;
                        ...
                        }), this.$element = t, this.element = t[0], this.axis = i.horizontal ? "horizontal" : "vertical", this.callback = i.handler, this.context = e, this.enabled = i.enabled, this.id = "waypoints" + v++, this.offset = null, this.options = i, e.waypoints[this.axis][this.id] = this, a[this.axis][this.id] = this, (o = null != (r = t.data(g)) ? r : []).push(this.id), t.data(g, o)
                    }
                    return t.prototype.trigger = function (t) {
                        if (this.enabled)
                            return null != this.callback && this.callback.apply(this.element, t), this.options.triggerOnce ? this.destroy() : void 0
                        ...
                        var e, i;
                        return (i = n(t).data(g)) ? (e = n.extend({}, a.horizontal, a.vertical), n.map(i, function (t) {
                            return e[t]
                        })) : []
                    }, t
                }(), h = {
                    init: function (t, e) {
                        return null == e && (e = {}), null == e.handler && (e.handler = t), this.each(function () {
                            var t, i, o, a;
                            return t = n(this), o = null != (a = e.context) ? a : n.fn[y].defaults.context, n.isWindow(o) || (o = t.closest(o)), o = n(o), (i = u[o.data(c)]) || (i = new r(o)), new s(t, i, e)
                        }), n[b]("refresh"), this
                    },
                    disable: function () {
                    ...
                    aggregate: function (t) {
                        var e, i, o;
                        return e = a, t && (e = null != (o = u[n(t).data(c)]) ? o.waypoints : void 0), e ? (i = {
                            horizontal: [],
                            vertical: []
                    ...
                    _filter: function (t, e, i) {
                        var o, r;
                        return (o = u[n(t).data(c)]) ? (r = [], n.each(o.waypoints[e], function (t, e) {
                            if (i(o, e))
                                return r.push(e)
                        }), r.sort(function (t, e) {
                            return t.offset - e.offset
    ...
    var e = function (n, i, o, r, s) {
        this.fallbackValue = o ? o && void 0 !== o.h ? o : this.value = {
            h: 0,
            s: 0,
            b: 0,
            a: 1
        } : null, this.fallbackFormat = r || "rgba", this.hexNumberSignPrefix = !0 === s, this.value = this.fallbackValue, this.origFormat = null, this.predefinedColors = i || {}, this.colors = t.extend({}, e.webColors, this.predefinedColors), n && (void 0 !== n.h ? this.value = n : this.setColor(String(n))), this.value || (this.value = {
            h: 0,
            s: 0,
            b: 0,
            a: 1
    ...
    e.webColors = {
        ...
        toRGB: function (t, e, n, i) {
            ...
            var o, r, s, a, l;
            return t = (t *= 360) % 360 / 60, l = n * e, a = l * (1 - Math.abs(t % 2 - 1)), o = r = s = n - l, t = ~~t, o += [l, a, 0, 0, a, l][t], r += [a, l, l, a, 0, 0][t], s += [0, 0, a, l, l, a][t], {
                r: Math.round(255 * o),
                g: Math.round(255 * r),
                b: Math.round(255 * s),
                a: i
        ...
        toHex: function (t, e, n, i) {
            ...
            return this.rgbaIsTransparent(o) ? "transparent" : (this.hexNumberSignPrefix ? "#" : "") + ((1 << 24) + (parseInt(o.r) << 16) + (parseInt(o.g) << 8) + parseInt(o.b)).toString(16).slice(1)
        },
        toHSL: function (t, e, n, i) {
            ...
            var o = t,
                    r = (2 - e) * n,
                    s = e * n;
            return s /= r > 0 && r <= 1 ? r : 2 - r, r /= 2, s > 1 && (s = 1), {
                h: isNaN(o) ? 0 : o,
                s: isNaN(s) ? 0 : s,
                l: isNaN(r) ? 0 : r,
                a: isNaN(i) ? 0 : i
        ...
        toAlias: function (t, e, n, i) {
            ...
            for (var a in this.colors)
                if ((o = this.colors[a].toLowerCase().trim()) === r || o === s)
                    return a;
            return !1
        },
        ...
        HSLtoRGB: function (t, e, n, i) {
            e < 0 && (e = 0);
            var o, r = 2 * n - (o = n <= .5 ? n * (1 + e) : n + e - n * e),
                    s = t + 1 / 3,
                    a = t,
                    l = t - 1 / 3;
            return [Math.round(255 * this.HueToRGB(r, o, s)), Math.round(255 * this.HueToRGB(r, o, a)), Math.round(255 * this.HueToRGB(r, o, l)), this._sanitizeNumber(i)]
        },
        parse: function (e) {
            ...
            var n, i, o = this,
                    r = !1,
                    s = void 0 !== this.colors[e];
            return s && (e = this.colors[e].toLowerCase().trim()), t.each(this.stringParsers, function (t, a) {
                var l = a.re.exec(e);
                return !(n = l && a.parse.apply(o, [l])) || (r = {}, i = s ? "alias" : a.format ? a.format : o.getValidFallbackFormat(), (r = i.match(/hsla?/) ? o.RGBtoHSB.apply(o, o.HSLtoRGB.apply(o, n)) : o.RGBtoHSB.apply(o, n)) instanceof Object && (r.format = i), !1)
            }), r
        },
        ...
        toString: function (t, n) {
            ...
            switch (t) {
                ...
                case "hex":
                    return this.toHex();
                case "alias":
                    return i = this.toAlias(), !1 === i ? this.toString(this.getValidFallbackFormat()) : n && !(i in e.webColors) && i in this.predefinedColors ? this.predefinedColors[i] : i;
                default:
                    return i
            }
        },
    ...
    var n = {
        ...
        colorSelectors: null
            ...
            i = function (e, i) {
                ...
                if (this.options.customClass && o.addClass(this.options.customClass), this.options.inline ? o.addClass("colorpicker-inline colorpicker-visible") : o.addClass("colorpicker-hidden"), this.options.horizontal && o.addClass("colorpicker-horizontal"), -1 === ["rgba", "hsla", "alias"].indexOf(this.format) && !1 !== this.options.format && "transparent" !== this.getValue() || o.addClass("colorpicker-with-alpha"), "right" === this.options.align && o.addClass("colorpicker-right"), !0 === this.options.inline && o.addClass("colorpicker-no-arrow"), this.options.colorSelectors) {
                    var r = this,
                ...
                }, this)), o.find(".colorpicker-saturation, .colorpicker-hue, .colorpicker-alpha").on("mousedown.colorpicker touchstart.colorpicker", t.proxy(this.mousedown, this)), o.appendTo(this.container ? this.container : t("body")), !1 !== this.input && (this.input.on({
    ...
    i.Color = e, i.prototype = {
        ...
        hide: function (e) {
            if (void 0 !== e && e.target && (t(e.currentTarget).parents(".colorpicker").length > 0 || t(e.target).parents(".colorpicker").length > 0))
                return !1;
            this.picker.addClass("colorpicker-hidden").removeClass("colorpicker-visible"), t(window).off("resize.colorpicker", this.reposition), t(window.document).off({
        ...
        getValue: function (t) {
            ...
            var e;
            return void 0 !== (e = this.hasInput() ? this.input.val() : this.element.data("color")) && "" !== e && null !== e || (e = t), e
        },
        hasInput: function () {
            return !1 !== this.input
        },
        ...
        mousedown: function (e) {
            ...
            var n = t(e.target).closest("div"),
                    i = this.options.horizontal ? this.options.slidersHorz : this.options.sliders;
            if (!n.is(".colorpicker")) {
                if (n.is(".colorpicker-saturation"))
                    this.currentSlider = t.extend({}, i.saturation);
                else if (n.is(".colorpicker-hue"))
                    this.currentSlider = t.extend({}, i.hue);
                else {
                    if (!n.is(".colorpicker-alpha"))
                        return !1;
                    this.currentSlider = t.extend({}, i.alpha)
                }
                var o = n.offset();
                this.currentSlider.guide = n.find("i")[0].style, this.currentSlider.left = e.pageX - o.left, this.currentSlider.top = e.pageY - o.top, this.mousePointer = {
                    left: e.pageX,
                    top: e.pageY
        ...
        mousemove: function (t) {
            ...
            return this.currentSlider.guide.left = e + "px", this.currentSlider.guide.top = n + "px", this.currentSlider.callLeft && this.color[this.currentSlider.callLeft].call(this.color, e / this.currentSlider.maxLeft), this.currentSlider.callTop && this.color[this.currentSlider.callTop].call(this.color, n / this.currentSlider.maxTop), !1 !== this.options.format || "setAlpha" !== this.currentSlider.callTop && "setAlpha" !== this.currentSlider.callLeft || (1 !== this.color.value.a ? (this.format = "rgba", this.color.origFormat = "rgba") : (this.format = "hex", this.color.origFormat = "hex")), this.update(!0), this.element.trigger({
                type: "changeColor",
                color: this.color
            }), !1
        },
